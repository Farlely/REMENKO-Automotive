...
INSERT INTO `Automodel` (`Automodel`, `AutomerkCode`) VALUES
(401, 'A4', 1);
...
ALTER TABLE `Automodel`
  ADD PRIMARY KEY (`Automodel`,`AutomerkCode`),
  ADD KEY `Automodel` (`Automodel`,`AutomerkCode`),
  ADD KEY `AutomerkCode` (`AutomerkCode`);
...
ALTER TABLE `Bouwjaar`
  ...
  ADD KEY `BouwjaarCode` (`BouwjaarCode`,`Automodel`,`DakTypeCode`),
  ADD KEY `AutomodelCode` (`Automodel`),
...
--
ALTER TABLE `Bouwjaar`
  ADD CONSTRAINT `bouwjaar_ibfk_1` FOREIGN KEY (`Automodel`) REFERENCES `Automodel` (`Automodel`),
